...
type (
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleRange]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleCalendarSpec]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleBackfill]
	...
	// instead.
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleIntervalSpec]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleSpec]
	ScheduleSpec struct {
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleWorkflowAction]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleOptions]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleWorkflowExecution]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleInfo]
	ScheduleInfo struct {
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleDescription]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.SchedulePolicies]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleState]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.Schedule]
	Schedule struct {
		// Action - Which Action to take
		Action ScheduleAction
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleUpdate]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleUpdateInput]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleUpdateOptions]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleTriggerOptions]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.SchedulePauseOptions]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleUnpauseOptions]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleBackfillOptions]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleActionResult]
	...
	// ScheduleListEntry
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleListEntry]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.ScheduleListOptions]
