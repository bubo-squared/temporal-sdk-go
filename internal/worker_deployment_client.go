...
// NOTE: Experimental
//
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentVersionDrainageStatus]
...
const (
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentVersionDrainageStatusUnspecified]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentVersionDrainageStatusDraining]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentVersionDrainageStatusDrained]
...
type (
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentDescribeOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentVersionSummary]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentInfo]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentDescribeResponse]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentSetCurrentVersionOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentSetCurrentVersionResponse]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentSetRampingVersionOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentSetRampingVersionResponse]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentSetManagerIdentityOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentSetManagerIdentityResponse]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentDescribeVersionOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentTaskQueueInfo]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentVersionDrainageInfo]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentVersionInfo]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentVersionDescription]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentDeleteVersionOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentDeleteVersionResponse]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentMetadataUpdate]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentUpdateVersionMetadataOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentUpdateVersionMetadataResponse]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentHandle]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentListOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentRoutingConfig]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentListEntry]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentListIterator]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentDeleteOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentDeleteResponse]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerDeploymentClient]
