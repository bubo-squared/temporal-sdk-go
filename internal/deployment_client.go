...
// NOTE: Experimental
//
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentReachability]
...
const (
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentReachabilityUnspecified]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentReachabilityReachable]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentReachabilityClosedWorkflows]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentReachabilityUnreachable]
...
type (
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.Deployment]
	Deployment struct {
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentTaskQueueInfo]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentInfo]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentDescription]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentListEntry]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentListOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentReachabilityInfo]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentMetadataUpdate]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentGetCurrentResponse]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentSetCurrentOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentSetCurrentResponse]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentDescribeOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentGetReachabilityOptions]
	...
	// NOTE: Experimental
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.DeploymentGetCurrentOptions]
