...
//
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.UnversionedBuildID]
...
//
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/temporal.VersioningIntent]
...
const (
	...
	// Deprecated: Build-id based versioning is deprecated in favor of worker deployment based versioning and will be removed soon.
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/temporal.VersioningIntentUnspecified]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/temporal.VersioningIntentCompatible]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/temporal.VersioningIntentDefault]
	...
	// Deprecated: Build-id based versioning is deprecated in favor of worker deployment based versioning and will be removed soon.
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/temporal.VersioningIntentInheritBuildID]
	...
	// Deprecated: Build-id based versioning is deprecated in favor of worker deployment based versioning and will be removed soon.
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/temporal.VersioningIntentUseAssignmentRules]
...
//
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.TaskReachability]
type TaskReachability int

const (
	// TaskReachabilityUnspecified indicates the reachability was not specified
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.TaskReachabilityUnspecified]
	TaskReachabilityUnspecified = iota
	// TaskReachabilityNewWorkflows indicates the Build Id might be used by new workflows
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.TaskReachabilityNewWorkflows]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.TaskReachabilityExistingWorkflows]
	TaskReachabilityExistingWorkflows
	// TaskReachabilityOpenWorkflows indicates the Build Id might be used by open workflows.
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.TaskReachabilityOpenWorkflows]
	TaskReachabilityOpenWorkflows
	// TaskReachabilityClosedWorkflows indicates the Build Id might be used by closed workflows
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.TaskReachabilityClosedWorkflows]
...
type (
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.UpdateWorkerBuildIdCompatibilityOptions]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.BuildIDOpAddNewIDInNewDefaultSet]
	BuildIDOpAddNewIDInNewDefaultSet struct {
		BuildID string
	}
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.BuildIDOpAddNewCompatibleVersion]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.BuildIDOpPromoteSet]
	BuildIDOpPromoteSet struct {
		BuildID string
	}
	//
	// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.BuildIDOpPromoteIDWithinSet]
...
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.GetWorkerBuildIdCompatibilityOptions]
type GetWorkerBuildIdCompatibilityOptions struct {
	TaskQueue string
	MaxSets   int
}

// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.GetWorkerTaskReachabilityOptions]
...
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerTaskReachability]
...
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.BuildIDReachability]
...
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.TaskQueueReachability]
...
//
// Exposed as: [github.com/bubo-squared/temporal-sdk-go/client.WorkerBuildIDVersionSets]
