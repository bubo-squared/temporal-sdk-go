...
//
// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.UnversionedBuildID]
...
//
// Exposed as: [github.com/bubo-squared/temporal-go-sdk/temporal.VersioningIntent]
...
const (
	...
	// Deprecated: Build-id based versioning is deprecated in favor of worker deployment based versioning and will be removed soon.
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/temporal.VersioningIntentUnspecified]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/temporal.VersioningIntentCompatible]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/temporal.VersioningIntentDefault]
	...
	// Deprecated: Build-id based versioning is deprecated in favor of worker deployment based versioning and will be removed soon.
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/temporal.VersioningIntentInheritBuildID]
	...
	// Deprecated: Build-id based versioning is deprecated in favor of worker deployment based versioning and will be removed soon.
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/temporal.VersioningIntentUseAssignmentRules]
...
//
// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.TaskReachability]
type TaskReachability int

const (
	// TaskReachabilityUnspecified indicates the reachability was not specified
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.TaskReachabilityUnspecified]
	TaskReachabilityUnspecified = iota
	// TaskReachabilityNewWorkflows indicates the Build Id might be used by new workflows
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.TaskReachabilityNewWorkflows]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.TaskReachabilityExistingWorkflows]
	TaskReachabilityExistingWorkflows
	// TaskReachabilityOpenWorkflows indicates the Build Id might be used by open workflows.
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.TaskReachabilityOpenWorkflows]
	TaskReachabilityOpenWorkflows
	// TaskReachabilityClosedWorkflows indicates the Build Id might be used by closed workflows
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.TaskReachabilityClosedWorkflows]
...
type (
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.UpdateWorkerBuildIdCompatibilityOptions]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.BuildIDOpAddNewIDInNewDefaultSet]
	BuildIDOpAddNewIDInNewDefaultSet struct {
		BuildID string
	}
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.BuildIDOpAddNewCompatibleVersion]
	...
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.BuildIDOpPromoteSet]
	BuildIDOpPromoteSet struct {
		BuildID string
	}
	//
	// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.BuildIDOpPromoteIDWithinSet]
...
// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.GetWorkerBuildIdCompatibilityOptions]
type GetWorkerBuildIdCompatibilityOptions struct {
	TaskQueue string
	MaxSets   int
}

// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.GetWorkerTaskReachabilityOptions]
...
// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.WorkerTaskReachability]
...
// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.BuildIDReachability]
...
// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.TaskQueueReachability]
...
//
// Exposed as: [github.com/bubo-squared/temporal-go-sdk/client.WorkerBuildIDVersionSets]
